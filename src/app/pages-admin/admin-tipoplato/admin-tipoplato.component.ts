...
export class AdminTipoplatoComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private adminTipoplatoervice: AdminTipoplatoService,
  ...
  subcripcionTipoplatos(): void {
    this.adminTipoplatoervice.getTipoplatos().pipe(
  ...
  public delete(tipoplato: Tipoplato): void {
    swalWithBootstrapButtons.fire({
      ...
      if (result.value) {
        this.adminTipoplatoervice.delete(tipoplato.id).subscribe(
          response => {
            this.adminTipoplatoervice.getTipoplatos().subscribe(respon => {
